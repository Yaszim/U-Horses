...
<body>
    <?php include "../nav.php"; ?>
        <div class="mx-10 items-center lg:px-8 p-2 bg-[#F4E9DF] rounded-2x1 w-80% border-solid border-2 border-[#331107]">
            ...
            <form action="../usuario/usuario.php" method="GET">
                    ...
                    <div class="flex grid grid-cols-3 grid-rows-7 mx-8 lg:px-8 p-3 bg-white rounded-2x1 w-80%">
                        ...
                        <div class="flex col-span-2 justify-between">
                            ...
                            <div class="justify-items-end text-end align-end items-end">
                                <a href="../menu/perfil.php" name="acao" id="acao" value="salvar"><button type="submit"  class="bg-[#E7CBB2] mr-2 w-50 rounded-md px-3 py-1.5 text-sm font-semibold leading-6 text-red-950 shandow-sm hover:bg-[#56291C] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">ALTERAR</button></a>
                                <button type="reset" class="bg-[#E7CBB2] w-50 mt-11 rounded-md px-3 py-1.5 text-sm font-semibold leading-6 text-red-950 shandow-sm hover:bg-[#56291C] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">VOLTAR</button>
                            </div>
                        </div>
                        </form>
                </div>
