        ...
        <div class="flex grid grid-cols-3 grid-rows-7 mx-16 lg:px-8 p-3 bg-white rounded-2x1 w-80% border-solid border-2 border-[#331107]">
            ...
            <div class="col-span-2 text-center items-center ">
                ...
                <div class="justify-items-end text-end align-end items-end">
                    <button type="submit" class="bg-[#E7CBB2] mr-2 w-50 rounded-md px-3 py-1.5 text-sm font-semibold leading-6 text-red-950 shandow-sm hover:bg-[#56291C] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">CADASTRAR</button>
